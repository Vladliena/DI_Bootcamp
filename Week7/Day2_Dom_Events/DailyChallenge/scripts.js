...
form.addEventListener('submit', (event) => {
    ...
    if (noun && adjective && person && verb && place){
        let storyText = `Deep in the heart of ${place}, a mischievous ${noun} with ${adjective} fur named ${person} would often play pranks on the local ${noun}. One day, they decided to ${verb} the mayor's office!`
        story.textContent = storyText
    } else story.textContent = 'All fields must be filled'
})
