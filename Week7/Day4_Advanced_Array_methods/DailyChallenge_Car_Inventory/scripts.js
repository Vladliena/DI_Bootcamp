...
function getCarHonda(carInventory){
    const hondaFirst = carInventory.find((car) => car.car_make === 'Honda')
    console.log(`This is a ${hondaFirst.car_make} ${hondaFirst.car_model} from ${hondaFirst.car_year}`)
}

const carString = getCarHonda(inventory)
